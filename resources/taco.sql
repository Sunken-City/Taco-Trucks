...
LOAD DATA INFILE '/home/justin/sites/TacoTruck/users.csv'
INTO TABLE users
...
-- ***************CHANGE THIS FILE PATH****************** 
LOAD DATA INFILE '/home/justin/sites/TacoTruck/orders.csv'
INTO TABLE orders
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
...
-- ***************CHANGE THIS FILE PATH****************** 
LOAD DATA INFILE '/home/justin/sites/TacoTruck/orderItem.csv'
INTO TABLE orderItem
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

CREATE TABLE fixinClass
(
...
-- ***************CHANGE THIS FILE PATH****************** 
LOAD DATA INFILE '/home/justin/sites/TacoTruck/fixinClass.csv'
INTO TABLE fixinClass
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
...
fixin_classId int,
PRIMARY KEY (fixinId),
FOREIGN KEY (fixin_classId) REFERENCES fixinClass (fixin_classId) ON UPDATE CASCADE ON DELETE CASCADE
);

-- ***************CHANGE THIS FILE PATH****************** 
LOAD DATA INFILE '/home/justin/sites/TacoTruck/fixins.csv'
INTO TABLE fixins
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
...
-- ***************CHANGE THIS FILE PATH****************** 
LOAD DATA INFILE '/home/justin/sites/TacoTruck/sauces.csv'
INTO TABLE sauces
COLUMNS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
...
-- ***************CHANGE THIS FILE PATH****************** 
LOAD DATA INFILE '/home/justin/sites/TacoTruck/orderItemDetails.csv'
